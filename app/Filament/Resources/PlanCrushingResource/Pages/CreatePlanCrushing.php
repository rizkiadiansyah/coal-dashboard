...
class CreatePlanCrushing extends CreateRecord
{
    ...
    protected function handleRecordCreation(array $data): Model
    {
        ...
        $isExists = \App\Models\PlanCrushing::query()
