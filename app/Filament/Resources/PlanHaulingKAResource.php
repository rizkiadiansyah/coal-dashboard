...
use App\Filament\Resources\PlanHaulingKAResource\Pages;
use App\Filament\Resources\PlanHaulingKAResource\RelationManagers;
...
class PlanHaulingKAResource extends Resource
{
    use HasFilamentRoleAccess;

    protected static ?string $model = PlanHaulingKA::class;

    protected static ?string $navigationIcon = 'heroicon-o-arrows-right-left';
    protected static ?string $navigationLabel = 'Plan Hauling KA';
    protected static ?string $modelLabel = 'Plan Hauling KA';
    protected static ?string $pluralModelLabel = 'Plan Hauling KA';
    ...
    {
        return [
            'index' => Pages\ListPlanHaulingKAs::route('/'),
            'create' => Pages\CreatePlanHaulingKA::route('/create'),
        ];
    }
