...
class PlanBargingWBSResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Plan Barging WBS';
    protected static ?string $modelLabel = 'Plan Barging WBS';
    protected static ?string $pluralModelLabel = 'Plan Barging WBS';
    ...
    {
        return [
            'index' => Pages\ListPlanBargingWBS::route('/'),
            'create' => Pages\CreatePlanBargingWBS::route('/create'),
        ];
    }
