...
class PlanStockpileWBSResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Plan Stockpile WBS';
    protected static ?string $modelLabel = 'Plan Stockpile WBS';
    protected static ?string $pluralModelLabel = 'Plan Stockpile WBS';
    ...
    {
        return [
            'index' => Pages\ListPlanStockpileWBS::route('/'),
            'create' => Pages\CreatePlanStockpileWBS::route('/create'),
        ];
    }
    ...
    {
        return DB::connection('mysql_wbs')
            ->table('tblmaterial')
