...
class PlanCoalGettingResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Plan Coal Getting';
    protected static ?string $modelLabel = 'Plan Coal Getting';
    protected static ?string $pluralModelLabel = 'Plan Coal Getting';
