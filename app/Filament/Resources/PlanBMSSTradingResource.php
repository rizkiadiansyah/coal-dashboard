...
class PlanBMSSTradingResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Plan BMSS Trading';
    protected static ?string $modelLabel = 'Plan BMSS Trading';
    protected static ?string $pluralModelLabel = 'Plan BMSS Trading';
    ...
    {
        return [
            'index' => Pages\ListPlanBMSSTradings::route('/'),
            'create' => Pages\CreatePlanBMSSTrading::route('/create'),
        ];
    }
